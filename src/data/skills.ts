export const skills = [
  {
    ...
    title: "Design Skills",
    description: "Print Design, Digital Design, Typography, Branding, Web Design, Digital Photography, Motion Design, and Digital Illustration.",
  },
   {
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M12 3a3 3 0 110 6 3 3 0 010-6zm0 6v6m0 0a3 3 0 100 6 3 3 0 000-6zm0 0a3 3 0 10-6 0 3 3 0 006 0zm6 0a3 3 0 11-6 0 3 3 0 016 0z"/></svg>`,
    title: "Soft Skills",
    description: "Teamwork, Listening, Organization, Communication, and Problem-Solving.",
  },
  {
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 3h8v8H3V3zm10 0h8v8h-8V3zM3 13h8v8H3v-8zm10 0h8v8h-8v-8z"/></svg>`,
    title: "Softwares",
    description: "Adobe Photoshop, Illustrator, InDesign, After Effects, Affinity, Clip Studio Paint, Microsof Office, Google Docs, Miro, and Rhinoceros 3D.",
  },
  {
    icon: `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M8 17l-5-5 5-5v3l-2 2 2 2v3zm8-10l5 5-5 5v-3l2-2-2-2V7z"/></svg>`,
    title: "Web Skills",
    description: "Experience with JavaScript, CSS, HTML, Figma, and Astro.",
  },
  // {
